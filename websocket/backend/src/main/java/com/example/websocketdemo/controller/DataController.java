...
import com.example.websocketdemo.service.DataService;
...
@Tag(name = "Data Management", description = "Operações CRUD para gerenciamento de dados com notificações WebSocket")
public class DataController {
    ...
    @Operation(summary = "Criar novo registro", description = "Cria um novo registro de dados e envia notificação WebSocket")
    @ApiResponses(value = {
    ...
    public ResponseEntity<DataEntity> createData(
        ...
        try {
            ...
            // Notificar via WebSocket sobre novo registro criado
    ...
    @Operation(summary = "Atualizar registro", description = "Atualiza um registro existente e envia notificação WebSocket")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Excluir registro", description = "Remove um registro pelo ID e envia notificação WebSocket")
    @ApiResponses(value = {
    ...
    public ResponseEntity<Void> deleteData(
        ...
        try {
            ...
            // Notificar via WebSocket sobre exclusão
            notificationService.sendInfoNotification(
    ...
    @Operation(summary = "Obter estatísticas", description = "Retorna estatísticas gerais dos dados e conexões WebSocket")
    @ApiResponses(value = {
    ...
    public ResponseEntity<Map<String, Object>> getStats() {
        ...
        Map<String, Object> stats = Map.of(
            ...
            "activeWebSocketConnections", notificationService.getActiveConnectionsCount()
        );
