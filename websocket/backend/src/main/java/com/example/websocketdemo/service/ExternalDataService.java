...
public class ExternalDataService {
    ...
    private final WebSocketNotificationService notificationService; // Mudança: WebSocket ao invés de SSE
        ...
        try {
            ...
            if (random.nextDouble() < 0.7) {
                ...
                if (!newData.isEmpty()) {
                    ...
                    String successMessage = messageService.getMessage("websocket.external.data.fetched", savedData.size());
    ...
    /**
     * Método público para simulação de API externa (para testes).
     *
     * @return Lista de dados simulados
     */
    public List<DataEntity> simulateExternalMessageFetch() {
